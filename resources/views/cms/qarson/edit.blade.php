            ...
            <div class="col-md-12">
                ...
                <div class="card card-primary">
                    <div class="card-header">
                        <h3 class="card-title">تعديل بيانات القرصون</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
                    <form id="create_form">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    value="{{ $qarsons->email}}"    placeholder="ادخل الايمل   ">
                                </div>
                            </div>
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <input type="text" name="mobile" class="form-control"
                                        id="mobile"      value="{{ $qarsons->user->mobile }}"
                                ...
                                <div class="form-group col-4 ">
                                    ...
                                    value="{{ $qarsons->user->date_of_birth }}"  placeholder="ادخل تاريخ الميلاد   ">
                                </div>
                                ...
                                <div class="form-group  col-4">
                                    ...
                                    <input type="text" name="salary_value" class="form-control"
                                        id="salary_value" value="{{ $qarsons->user->salary_value }}" placeholder="ادخل قيمة الراتب  ">
                                </div>
                                </div>
                                <br>
                                <div class="row">
                                ...
                                <div class="form-group col-4">
                                    ...
                                    <select class="form-control" name="salary_type" style="width: 100%;"
                                        ...
                                        <option selected> {{ $qarsons->user->salary_type }} </option>
                        ...
                        <div class="card-footer">
                            <button type="button" onclick="update({{$qarsons->id}})" class="btn btn-lg btn-success">تعديل</button>
...
$('.city_id').select2({
    ...
    function update(id){
        ...
        let formData = new FormData();
            ...
            storeRoute('/cms/admin/update_qarsons/'+id , formData );
