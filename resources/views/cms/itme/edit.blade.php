              ...
              <div class="card card-primary">
                  ...
                  <form id="create_form">
                    ...
                    <div class="row">
                          ...
                          <div class="form-group col-md-6">
                              ...
                              <input type="text" name="name_product" class="form-control" id="name_product"
                                  placeholder="أدخل اسم المنتج" value="{{ $items->name_product }}">
                          </div>

                          <div class="form-group col-md-6">
                              <label for="price"> السعر</label>
                              <input type="text" name="price" class="form-control" id="price"
                                  placeholder="ادخل  السعر" value="{{ $items->price }}">
                          </div>
                      </div>
                      <div class="row">
                          <div class="form-group col-md-6">
                    ...
                    <div class="card-footer">
                        <button type="button" onclick="performUpdate({{ $items->id }})" class="btn btn-lg btn-success">حفظ</button>
...
<script>
    ...
    storeRoute('/cms/admin/update_items/'+id , formData );
    }
    </script>
