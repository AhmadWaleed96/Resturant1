                        ...
                        <div class="card-body">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    value="{{ $admins->email}}"    placeholder="ادخل الايمل   ">
                                </div>
                            </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" name="mobile" class="form-control"
                                        id="mobile"      value="{{ $admins->user->mobile }}"
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    value="{{ $admins->user->date_of_birth }}"  placeholder="ادخل تاريخ الميلاد   ">
                                </div>

                                <div class="form-group col-md-3">
                                    <label for="speciality"> التخصص </label>
                                    <input type="text" name="speciality" class="form-control"
                                        id="speciality" value="{{ $admins->user->speciality }}" placeholder="ادخل التخصص  ">
                                </div>
                                <div class="form-group col-md-3">
                                    <label for="salary_value"> قيمة الراتب </label>
                                    <input type="text" name="salary_value" class="form-control"
                                        id="salary_value" value="{{ $admins->user->salary_value }}" placeholder="ادخل قيمة الراتب  ">
                                </div>
                                </div>
                                <br>
                                <div class="row">
