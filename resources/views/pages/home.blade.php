...
<main id="main">
        ...
        <div class="container" data-aos="fade-up">
            ...
            <div class="row">
                <div class="col-lg-6 order-1 order-lg-2" data-aos="zoom-in" data-aos-delay="100">
                    <div class="about-img">
                        <img src="{{asset('pages/assets/img/about.jpg')}}" alt="">
                    </div>
                </div>
    ...
    @endphp
            <div class="row menu-container" data-aos="fade-up" data-aos-delay="200">
                ...
                <div class="col-lg-6 menu-item filter-starters">
                    <img src="{{asset('pages/assets/img/menu/cake.jpg')}}" class="menu-img" alt="">
                    <div class="menu-content">
                ...
                <div class="col-lg-6 menu-item filter-salads">
                    <img src="{{asset('pages/assets/img/menu/caesar.jpg')}}" class="menu-img" alt="">
                    <div class="menu-content">
                ...
                <div class="col-lg-6 menu-item filter-specialty">
                    <img src="{{asset('pages/assets/img/menu/tuscan-grilled.jpg')}}" class="menu-img" alt="">
                    <div class="menu-content">
                ...
                <div class="col-lg-6 menu-item filter-starters">
                    <img src="{{asset('pages/assets/img/menu/mozzarella.jpg')}}" class="menu-img" alt="">
                    <div class="menu-content">
                ...
                <div class="col-lg-6 menu-item filter-salads">
                    <img src="{{asset('pages/assets/img/menu/greek-salad.jpg')}}" class="menu-img" alt="">
                    <div class="menu-content">
                ...
                <div class="col-lg-6 menu-item filter-salads">
                    <img src="{{asset('pages/assets/img/menu/spinach-salad.jpg')}}" class="menu-img" alt="">
                    <div class="menu-content">
                ...
                <div class="col-lg-6 menu-item filter-specialty">
                    <img src="{{asset('pages/assets/img/menu/lobster-roll.jpg')}}" class="menu-img" alt="">
                    <div class="menu-content">
                    ...
                    <div class="tab-content">
                        <div class="tab-pane active show" id="tab-1">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{asset('pages/assets/img/specials-1.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-2">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{asset('pages/assets/img/specials-2.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-3">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{asset('pages/assets/img/specials-3.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-4">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{asset('pages/assets/img/specials-4.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                        <div class="tab-pane" id="tab-5">
                            <div class="row">
                                ...
                                <div class="col-lg-4 text-center order-1 order-lg-2">
                                    <img src="{{asset('pages/assets/img/specials-5.png')}}" alt="" class="img-fluid">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="swiper-wrapper">
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="{{asset('pages/assets/img/event-birthday.jpg')}}" class="img-fluid" alt="">
                            </div>
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="{{asset('pages/assets/img/event-private.jpg')}}" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
                    ...
                    <div class="swiper-slide">
                        <div class="row event-item">
                            <div class="col-lg-6">
                                <img src="{{asset('pages/assets/img/event-custom.jpg')}}" class="img-fluid" alt="">
                            </div>
                            <div class="col-lg-6 pt-4 pt-lg-0 content">
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-1.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-1.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-2.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-2.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-3.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-3.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-4.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-4.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-5.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-5.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-6.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-6.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-7.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-7.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
                ...
                <div class="col-lg-3 col-md-4">
                    <div class="gallery-item">
                        <a href="assets/img/gallery/gallery-8.jpg" class="gallery-lightbox" data-gall="gallery-item">
                            <img src="{{asset('pages/assets/img/gallery/gallery-8.jpg')}}" alt="" class="img-fluid">
                        </a>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="100">
                        <img src="{{asset('pages/assets/img/chefs/chefs-1.jpg')}}" class="img-fluid" alt="">
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="200">
                        <img src="{{asset('pages/assets/img/chefs/chefs-2.jpg')}}" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
                                <h4>Sarah Jhonson</h4>
                                <span>Patissier</span>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="member" data-aos="zoom-in" data-aos-delay="300">
                        <img src="{{asset('pages/assets/img/chefs/chefs-3.jpg')}}" class="img-fluid" alt="">
                        <div class="member-info">
                            <div class="member-info-content">
