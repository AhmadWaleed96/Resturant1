...
<head>
    ...
    <!-- Favicons -->
    <link href="{{asset("pages/assets/img/Untitled-2.png")}}" rel="icon">
    ...
    <header style="background-color: rgba(35, 43, 56, 0);">
        <div class="container">
            <div class="top-head">
                ...
                <ul class="top-menu">
                    <li><a href="{{ route('admins.index') }}"><i class="fas fa-user"></i>Log In</a></li>
    ...
    <header id="header" class="fixed-top d-flex align-items-cente">
        <div class="container-fluid container-xl d-flex align-items-center justify-content-lg-between">
            ...
            <nav id="navbar" class="navbar order-last order-lg-0">
                <ul>
                    <li><a class="nav-link scrollto " href="{{  route('restaurant.home') }}">Home</a></li>
                    ...
                    <li><a class="nav-link scrollto" href="{{ route('restaurant.delivery') }}">Delivery</a></li>
